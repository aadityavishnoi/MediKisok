import { CLINICAL_QUESTION_GRAPH } from '../graph/ClinicalQuestionGraph.js';
import { SymptomNormalizer } from '../normalization/SymptomNormalizer.ts';
export class NextBestQuestionRanker {
    ...
    static computeDifferentials(symptomCodes, regionalSignal) {
        ...
        if (symptomCodes.has('SYMPT_FEVER') || symptomCodes.has('SYMPT_COUGH') || symptomCodes.has('SYMPT_DYSPNEA')) {
            const isRegionalOutbreak = regionalSignal &&
        ...
        if (symptomCodes.has('SYMPT_FEVER') && symptomCodes.has('SYMPT_CHILLS')) {
            const isDengueOutbreak = regionalSignal &&
...
//# sourceMappingURL=NextBestQuestionRanker.js.map