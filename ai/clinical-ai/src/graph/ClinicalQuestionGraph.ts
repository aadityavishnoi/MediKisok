/**
 * Developer 1: Clinical Question Knowledge Graph
 * Graph structure of dynamic diagnostic questions with red flag rules and disease relevance.
 */
import type { ClinicalQuestion } from '../../../shared/types/index';

export const CLINICAL_QUESTION_GRAPH: ClinicalQuestion[] = [
