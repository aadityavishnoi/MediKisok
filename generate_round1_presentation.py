...
def create_5slide_round1_presentation():
    ...
    usps = [
        ("🛡️ 0.0% Hallucination: Evidence Source Chips", 
         "Every single statement generated by the clinical AI copilot contains clickable citation chips ([Answer #12], [Doc #03]). The physician can click to verify against raw voice transcripts or scanned document images. Any ungrounded claim is deterministically blocked.", Inches(0.8), Inches(1.6)),
    ...
    s4.notes_slide.notes_text_frame.text = (
        ...
        "enforces a 0.0% unsupported claim rate: every claim must have a clickable link back to an answer or prescription "
        "box. Third, we natively support both Allopathic and AYUSH clinical models."
    )
